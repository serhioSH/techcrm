# ============================================================
# TECHCRM POS - Instalador Profesional v3.0
...
# INSTALACIÓN
Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host " INSTALADOR DE $AppName v3.0" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan

# Verificar archivos fuente
$SourcePath = Join-Path $PSScriptRoot "TECHCRM-POS"
if (-not (Test-Path $SourcePath)) {
    Write-Host "ERROR: No se encontraron los archivos de instalación en:" -ForegroundColor Red
...
if (-not (Test-Path $ExePath)) {
    Write-Host "ERROR: No se encontró TECHCRM-POS.exe" -ForegroundColor Red
    Read-Host "Presiona ENTER para salir"
    exit 1
}
...
# Copiar archivos
Write-Host "`nCopiando archivos (esto puede tardar unos segundos)..." -ForegroundColor Yellow
...
Set-ItemProperty -Path $UninstallKey -Name "DisplayVersion" -Value "3.0.0"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUyeBfNwHKV1Z6BQtSPCXgK3sy
# bkKgggMAMIIC/DCCAeSgAwIBAgIQckhS3YzLj7dI33GgvG3BkzANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUclQgIWlVGNBG1wkDgIfnPzSB
# 1+MwDQYJKoZIhvcNAQEBBQAEggEAe+wUFg6Q25ODv0Bf4Lp+QjXellrcT4tcRbWI
# fjs0Z9hD5aNdgZR78Mf/bGU6niLnT3Sk8+jfYg/8hSSW0QMf3vAci5fv5nrJH3Bu
# tHrrxkslgNQ2cUuNLbrEHlLM+0BfM7USVJnxrcqz48QkaX0cPQKTJoX4mewTFKfb
# nZmInU62gMQbDVNefZU7xxKZNjolQ0UrFIqIfYP7OwTwFfdjC1HN7seVC1NkZ5TO
# awmee83phWVKQm/2RiQqXc8XuBxlNJAlDt/2XARnxSJWe4lzI+AzHXKi9fjp3xhH
# qcUjEui5u1XiyveuivT33POtZi5uetZPG6kXbO0V2XZfqy3LJQ==

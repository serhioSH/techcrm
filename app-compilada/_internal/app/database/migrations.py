...
# ============================================================
# MIGRACION v9 — Inventario informativo y empaques domicilios
...
# ============================================================
# MIGRACION v9 — Inventario de materias primas y empaques domicilios
# ============================================================
MIGRACION_V9_SQL = """
...
CREATE TABLE IF NOT EXISTS empaques_domicilio (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    nombre          TEXT NOT NULL UNIQUE,
    descripcion     TEXT,
    stock           INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS ventas_empaques (
    id              INTEGER PRIMARY KEY AUTOINCREMENT,
    venta_id        INTEGER NOT NULL UNIQUE REFERENCES ventas(id) ON DELETE CASCADE,
    empaque_id      INTEGER REFERENCES empaques_domicilio(id),
...
CREATE TABLE IF NOT EXISTS inventario_snapshots (
    ...
    fecha_snapshot  TEXT NOT NULL DEFAULT (datetime('now','localtime')),
...
CREATE INDEX IF NOT EXISTS idx_empaques_activo ON empaques_domicilio(activo);
CREATE INDEX IF NOT EXISTS idx_ventas_empaques_venta ON ventas_empaques(venta_id);
CREATE INDEX IF NOT EXISTS idx_ventas_empaques_empaque ON ventas_empaques(empaque_id);
CREATE INDEX IF NOT EXISTS idx_inventario_snapshots_caja ON inventario_snapshots(caja_id);
CREATE INDEX IF NOT EXISTS idx_inventario_snapshots_fecha ON inventario_snapshots(fecha_snapshot);
"""
...
MIGRACIONES = [
    ...
    (8, "Pagos mixtos: agregar columnas efectivo_pago y transferencia_pago para manejar correctamente",
     MIGRACION_V8_SQL),
    (9, "Inventario informativo y empaques domicilios (stock no deducible en productos, obligatorio en empaques)",
     MIGRACION_V9_SQL),
]
